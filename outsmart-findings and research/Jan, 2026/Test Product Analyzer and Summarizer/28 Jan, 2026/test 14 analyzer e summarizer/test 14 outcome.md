...
# Summarizer `Update` tool call 1 [NOTA: Gli Output di queste chiamate sono talmente lunghi che non mi é consentito mandarmeli come debug su Telegram poiché troppo lunghi, quindi li sto raccogliendo da dentro n8n]
````
"product_analyst_summary": 
